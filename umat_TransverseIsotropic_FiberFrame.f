        ...
        do n = 1, 3
          do i = 1, 3
            do j = 1, 3
			  ...
			  STRESSM_rot(m,n) = STRESSM_rot(m,n) + Q(j,n)*STRESSM(i,j)*Q(i,m)
            end do
          end do
        end do
      end do
...
C Stress increment evaluation
      ...
      do m = 1, 3
        do n = 1, 3
          do i = 1, 3
            do j = 1, 3
			  STRESSM_rot_n_rot(m,n) = STRESSM_rot_n_rot(m,n) + Q(n,j)*STRESSM_rot_n(i,j)*Q(m,i)
            end do
          end do
        end do
      end do
            ...
            do l = 1, 3
			  do m = 1, 3
				do n = 1, 3
				  do o = 1, 3
					do p = 1, 3
					  C2(i,j,k,l) = C2(i,j,k,l) + Q(i,m)*Q(j,n)*Q(k,o)*Q(l,p)*C1(m,n,o,p)
					end do
				  end do
				end do
			  end do
